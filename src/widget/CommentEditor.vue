<template>
    <div class="comment-editor">
        <div class="cancel-reply" title="取消回复" 
            v-show="isReplying" 
        ...
        <div class="toolbar">
            <div class="preview">
                <div class="button" title="预览" v-on:click="previewVisible = !previewVisible">
                ...
                <div class="button" title="表情" v-if="true" v-on:click="smiliesVisible = !smiliesVisible">
            ...
            <div class="submit">
                <div class="captcha" v-if="captchaEnabled">
                    <img title="点击刷新" style="border-radius: 3px;" v-bind:src="captchaUrl" v-on:click="refreshCaptcha"></img>
                    <input type="text" class="input" style="margin-left: 7px;" placeholder="验证码" v-model="formData.captcha">
                </div>
                <div type="button" class="button" v-on:click="onComment">提交</div>
            </div>
        </div>
        ...
        <div class="panels">
            ...
            <div class="preview-panel" v-if="previewVisible">
                <div>预览</div>
                <div class="markdown" v-html="formData.content? parseMarkdown(formData.content):''"></div>
            </div>
            
            <div class="smilies-panel" v-show="smiliesVisible">
                <div>表情</div>
                <div class="">
        ...
        <div class="alert-info" v-show="alertMessage.text!=''">
            <div class="h">
                <div class="text" v-html="alertMessage.text"></div>
                <button type="button" class="button" v-on:click="hideAlert">{{alertMessage.button}}</button>
            </div>
        </div>
    </div>
</template>
